          ...
          <div className="flex-1 overflow-y-auto">
            {cashiers.map(c => (
              <button
                ...
                className={`w-full flex items-center gap-3 p-3 border-b border-slate-100 dark:border-slate-800/50 transition text-left ${
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${
                  selectedCashierId === c.id ? 'bg-white/20 text-white' : 'bg-slate-200 dark:bg-[#2a2d32] text-slate-500'
                }`}>
              ...
              <div className="flex flex-wrap bg-slate-100 dark:bg-[#25282d] border-b border-slate-200 dark:border-slate-700">
                {['Ventas', 'Clientes', 'Productos', 'Inventario', 'Otros'].map(tab => (
                  <button
                    ...
                    className={`px-4 py-2.5 text-sm font-bold transition flex items-center gap-2 ${
